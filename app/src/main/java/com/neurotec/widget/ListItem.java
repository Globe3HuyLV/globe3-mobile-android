...
public class ListItem implements Parcelable {
	...
	private ViewHolder createViewHolder(View rowView) {
		...
		viewHolder.layout = (LinearLayout) rowView.findViewById(R.id.neurotec_list_item_layout);
	...
	public View inflate(View convertView, LayoutInflater inflater) {
		...
		if (rowView == null) {
			rowView = inflater.inflate(R.layout.neurotec_list_item, null);
