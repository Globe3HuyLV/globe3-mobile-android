...
public class LogTimeFragment extends DialogFragment {
    ...
    final static int[] ACTION_TEXT_COLOR = {R.color.colorMenuLight, R.color.colorAccent, R.color.colorMenuLight, R.color.colorAccent, R.color.colorAccent, R.color.colorAccent};
    final static int[] CANCEL_TEXT_COLOR = {R.color.colorMenuLight, R.color.colorBlueGrey, R.color.colorMenuLight, R.color.colorBlueGrey, R.color.colorBlueGrey, R.color.colorBlueGrey};
    ...
    private void selectSalesOrder(){
        ...
        log_time_sale_order_fragment.setLogTimeFragment(this);
