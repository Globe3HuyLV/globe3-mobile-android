...
public class SalesOrderListAdapter extends RecyclerView.Adapter<SalesOrderListAdapter.ViewHolder> {
    ...
    public SalesOrderListAdapter(ArrayList<RowSalesOrder> sales_orderList, Context parentContext) {
    ...
    @Override
    public SalesOrderListAdapter.ViewHolder onCreateViewHolder(ViewGroup parentView, int viewType) {
        View rowView = LayoutInflater.from(parentView.getContext()).inflate(R.layout.row_sales_order, parentView, false);
